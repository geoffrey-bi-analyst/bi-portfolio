...
const socialLinks = [
  {
    href: 'https://www.linkedin.com/in/geoffrey-gari-3895582a1/',
    label: 'LinkedIn',
    icon: (
    ...
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400 max-w-sm">
              Business Intelligence Analyst specializing in data-driven decision making,
              interactive dashboards, and business strategy. Based in Nairobi, Kenya.
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2">
              ...
              <li>
                <Link href="/resume" className="text-sm text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                  Resume
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-500 dark:text-gray-400">
          &copy; {new Date().getFullYear()} Geoffrey Kenga. All rights reserved.
        </div>
      </div>
    </footer>
  )
